...
public class QUser extends EntityPathBase<User> {
    ...
    public QUser(Class<? extends User> type, PathMetadata metadata, PathInits inits) {
        ...
        this.meetingGroup = inits.isInitialized("meetingGroup") ? new com.ssafy.project.domain.group.QMeetingGroup(forProperty("meetingGroup"), inits.get("meetingGroup")) : null;
    }
