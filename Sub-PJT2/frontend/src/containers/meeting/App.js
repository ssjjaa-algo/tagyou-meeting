...
class App extends Component {
    ...
    constructor(props) {
        ...
        this.setGameStart = this.setGameStart.bind(this);
    ...
    renderSelectedGame = () => {
        if (this.state.selectedGame === "catchMind") {
            return <CatchMind publisher={this.state.publisher} subscribers={this.state.subscribers}/>;
        } else if (this.state.selectedGame === "sonByeonHo") {
            return <SonByeonHo publisher={this.state.publisher} subscribers={this.state.subscribers}/>;
        } else if (this.state.selectedGame === "sis") {
            return <Sis publisher={this.state.publisher} subscribers={this.state.subscribers}/>;
        }
    };
    ...
    render() { 
        ...
        return (
            <S.Container
                class={!InGameChatStatus ? "Container-Son" : "Container-Son-withChat"}
            >
                <Header />
                    ...
                    >
                        <S.InnerContainer>
                            {RoomInfo.roomType === "One" ? (
                                <S.PlayerVidBundle>
                                    <S.PlayerVid><UserVideoComponent streamManager={this.state.publisher} /></S.PlayerVid>
                                </S.PlayerVidBundle>
                            ) : (
                                <S.PlayerVidBundle>
                                    <S.PlayerVid><UserVideoComponent streamManager={this.state.publisher} /></S.PlayerVid>
                            ...
                            <S.Middle>
                                <select
                                    ...
                                    onChange={(e) => this.setSelectedGame(e.target.value)}
                                >
                                ...
                                <button onClick={() => this.setGameStart(true)}>게임 시작</button>
                            </S.Middle>
                            <S.PlayerVidBundle>
